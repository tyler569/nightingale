...
build-x86_64/libc.a: build-x86_64/libc/crt0.o build-x86_64/libc/crti.o build-x86_64/libc/crtn.o build-x86_64/libc/ctype.o build-x86_64/libc/entry.o build-x86_64/libc/errno.o build-x86_64/libc/fstdio.o build-x86_64/libc/fstdio_unlocked.o build-x86_64/libc/getopt.o build-x86_64/libc/locale.o build-x86_64/libc/malloc.o build-x86_64/libc/nightingale.o build-x86_64/libc/setjmp.o build-x86_64/libc/signal.o build-x86_64/libc/stdio.o build-x86_64/libc/stdlib.o build-x86_64/libc/string.o build-x86_64/libc/strtod.o build-x86_64/libc/syscall.o build-x86_64/libc/syscalls.o build-x86_64/libc/time.o build-x86_64/libc/todo.o build-x86_64/libc/unistd.o build-x86_64/libc/vector.o build-x86_64/libc/x86_64/nightingale.o 
	...
	@x86_64-nightingale-ar rcs -o build-x86_64/libc.a build-x86_64/libc/crt0.o build-x86_64/libc/crti.o build-x86_64/libc/crtn.o build-x86_64/libc/ctype.o build-x86_64/libc/entry.o build-x86_64/libc/errno.o build-x86_64/libc/fstdio.o build-x86_64/libc/fstdio_unlocked.o build-x86_64/libc/getopt.o build-x86_64/libc/locale.o build-x86_64/libc/malloc.o build-x86_64/libc/nightingale.o build-x86_64/libc/setjmp.o build-x86_64/libc/signal.o build-x86_64/libc/stdio.o build-x86_64/libc/stdlib.o build-x86_64/libc/string.o build-x86_64/libc/strtod.o build-x86_64/libc/syscall.o build-x86_64/libc/syscalls.o build-x86_64/libc/time.o build-x86_64/libc/todo.o build-x86_64/libc/unistd.o build-x86_64/libc/vector.o build-x86_64/libc/x86_64/nightingale.o
build-x86_64/libc/crt0.o: libc/crt0.S
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,AS	crt0.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc/crt0.d -c libc/crt0.S -o build-x86_64/libc/crt0.o
build-x86_64/libc/crti.o: libc/crti.S
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,AS	crti.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc/crti.d -c libc/crti.S -o build-x86_64/libc/crti.o
build-x86_64/libc/crtn.o: libc/crtn.S
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,AS	crtn.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc/crtn.d -c libc/crtn.S -o build-x86_64/libc/crtn.o
build-x86_64/libc/ctype.o: libc/ctype.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	ctype.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/ctype.d -c libc/ctype.c -o build-x86_64/libc/ctype.o
build-x86_64/libc/entry.o: libc/entry.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	entry.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/entry.d -c libc/entry.c -o build-x86_64/libc/entry.o
build-x86_64/libc/errno.o: libc/errno.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	errno.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/errno.d -c libc/errno.c -o build-x86_64/libc/errno.o
build-x86_64/libc/fstdio.o: libc/fstdio.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	fstdio.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/fstdio.d -c libc/fstdio.c -o build-x86_64/libc/fstdio.o
build-x86_64/libc/fstdio_unlocked.o: libc/fstdio_unlocked.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	fstdio_unlocked.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/fstdio_unlocked.d -c libc/fstdio_unlocked.c -o build-x86_64/libc/fstdio_unlocked.o
build-x86_64/libc/getopt.o: libc/getopt.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	getopt.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/getopt.d -c libc/getopt.c -o build-x86_64/libc/getopt.o
build-x86_64/libc/locale.o: libc/locale.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	locale.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/locale.d -c libc/locale.c -o build-x86_64/libc/locale.o
build-x86_64/libc/malloc.o: libc/malloc.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	malloc.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/malloc.d -c libc/malloc.c -o build-x86_64/libc/malloc.o
build-x86_64/libc/nightingale.o: libc/nightingale.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	nightingale.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/nightingale.d -c libc/nightingale.c -o build-x86_64/libc/nightingale.o
build-x86_64/libc/setjmp.o: libc/setjmp.S
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,AS	setjmp.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc/setjmp.d -c libc/setjmp.S -o build-x86_64/libc/setjmp.o
build-x86_64/libc/signal.o: libc/signal.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	signal.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/signal.d -c libc/signal.c -o build-x86_64/libc/signal.o
build-x86_64/libc/stdio.o: libc/stdio.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	stdio.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/stdio.d -c libc/stdio.c -o build-x86_64/libc/stdio.o
build-x86_64/libc/stdlib.o: libc/stdlib.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	stdlib.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/stdlib.d -c libc/stdlib.c -o build-x86_64/libc/stdlib.o
build-x86_64/libc/string.o: libc/string.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	string.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/string.d -c libc/string.c -o build-x86_64/libc/string.o
build-x86_64/libc/strtod.o: libc/strtod.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	strtod.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/strtod.d -c libc/strtod.c -o build-x86_64/libc/strtod.o
build-x86_64/libc/syscall.o: libc/syscall.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	syscall.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/syscall.d -c libc/syscall.c -o build-x86_64/libc/syscall.o
build-x86_64/libc/syscalls.o: libc/syscalls.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	syscalls.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/syscalls.d -c libc/syscalls.c -o build-x86_64/libc/syscalls.o
build-x86_64/libc/time.o: libc/time.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	time.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/time.d -c libc/time.c -o build-x86_64/libc/time.o
build-x86_64/libc/todo.o: libc/todo.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	todo.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/todo.d -c libc/todo.c -o build-x86_64/libc/todo.o
build-x86_64/libc/unistd.o: libc/unistd.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	unistd.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/unistd.d -c libc/unistd.c -o build-x86_64/libc/unistd.o
build-x86_64/libc/vector.o: libc/vector.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	vector.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/vector.d -c libc/vector.c -o build-x86_64/libc/vector.o
build-x86_64/libc/x86_64/nightingale.o: libc/x86_64/nightingale.c
	@mkdir -p build-x86_64/libc/x86_64
	@mkdir -p dep/libc/x86_64
	$(call MP_INFO,CC	nightingale.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/x86_64/nightingale.d -c libc/x86_64/nightingale.c -o build-x86_64/libc/x86_64/nightingale.o
build-x86_64/libm.a: build-x86_64/libm/complex.o build-x86_64/libm/double.o 
	$(call MP_INFO,AR	libm.a)
	@x86_64-nightingale-ar rcs -o build-x86_64/libm.a build-x86_64/libm/complex.o build-x86_64/libm/double.o
build-x86_64/libm/complex.o: libm/complex.c
	@mkdir -p build-x86_64/libm
	@mkdir -p dep/libm
	$(call MP_INFO,CC	complex.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libm/complex.d -c libm/complex.c -o build-x86_64/libm/complex.o
build-x86_64/libm/double.o: libm/double.c
	@mkdir -p build-x86_64/libm
	@mkdir -p dep/libm
	$(call MP_INFO,CC	double.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libm/double.d -c libm/double.c -o build-x86_64/libm/double.o
build-x86_64/libelf.a: build-x86_64/libelf/elf-ng.o 
	$(call MP_INFO,AR	libelf.a)
	@x86_64-nightingale-ar rcs -o build-x86_64/libelf.a build-x86_64/libelf/elf-ng.o
build-x86_64/libelf/elf-ng.o: linker/elf-ng.c
	@mkdir -p build-x86_64/libelf
	@mkdir -p dep/libelf
	$(call MP_INFO,CC	elf-ng.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libelf/elf-ng.d -c linker/elf-ng.c -o build-x86_64/libelf/elf-ng.o
...
build-x86_64/libc_so/crt0.o: libc/crt0.S
	...
	@mkdir -p dep/libc_so
	$(call MP_INFO,AS	crt0.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc_so/crt0.d -c libc/crt0.S -o build-x86_64/libc_so/crt0.o
build-x86_64/libc_so/crti.o: libc/crti.S
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,AS	crti.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc_so/crti.d -c libc/crti.S -o build-x86_64/libc_so/crti.o
build-x86_64/libc_so/crtn.o: libc/crtn.S
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,AS	crtn.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc_so/crtn.d -c libc/crtn.S -o build-x86_64/libc_so/crtn.o
build-x86_64/libc_so/ctype.o: libc/ctype.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	ctype.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/ctype.d -c libc/ctype.c -o build-x86_64/libc_so/ctype.o
build-x86_64/libc_so/entry.o: libc/entry.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	entry.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/entry.d -c libc/entry.c -o build-x86_64/libc_so/entry.o
build-x86_64/libc_so/errno.o: libc/errno.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	errno.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/errno.d -c libc/errno.c -o build-x86_64/libc_so/errno.o
build-x86_64/libc_so/fstdio.o: libc/fstdio.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	fstdio.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/fstdio.d -c libc/fstdio.c -o build-x86_64/libc_so/fstdio.o
build-x86_64/libc_so/fstdio_unlocked.o: libc/fstdio_unlocked.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	fstdio_unlocked.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/fstdio_unlocked.d -c libc/fstdio_unlocked.c -o build-x86_64/libc_so/fstdio_unlocked.o
build-x86_64/libc_so/getopt.o: libc/getopt.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	getopt.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/getopt.d -c libc/getopt.c -o build-x86_64/libc_so/getopt.o
build-x86_64/libc_so/locale.o: libc/locale.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	locale.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/locale.d -c libc/locale.c -o build-x86_64/libc_so/locale.o
build-x86_64/libc_so/malloc.o: libc/malloc.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	malloc.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/malloc.d -c libc/malloc.c -o build-x86_64/libc_so/malloc.o
build-x86_64/libc_so/nightingale.o: libc/nightingale.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	nightingale.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/nightingale.d -c libc/nightingale.c -o build-x86_64/libc_so/nightingale.o
build-x86_64/libc_so/setjmp.o: libc/setjmp.S
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,AS	setjmp.o)
	@x86_64-nightingale-gcc  -MD -MF dep/libc_so/setjmp.d -c libc/setjmp.S -o build-x86_64/libc_so/setjmp.o
build-x86_64/libc_so/signal.o: libc/signal.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	signal.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/signal.d -c libc/signal.c -o build-x86_64/libc_so/signal.o
build-x86_64/libc_so/stdio.o: libc/stdio.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	stdio.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/stdio.d -c libc/stdio.c -o build-x86_64/libc_so/stdio.o
build-x86_64/libc_so/stdlib.o: libc/stdlib.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	stdlib.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/stdlib.d -c libc/stdlib.c -o build-x86_64/libc_so/stdlib.o
build-x86_64/libc_so/string.o: libc/string.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	string.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/string.d -c libc/string.c -o build-x86_64/libc_so/string.o
build-x86_64/libc_so/strtod.o: libc/strtod.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	strtod.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/strtod.d -c libc/strtod.c -o build-x86_64/libc_so/strtod.o
build-x86_64/libc_so/syscall.o: libc/syscall.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	syscall.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/syscall.d -c libc/syscall.c -o build-x86_64/libc_so/syscall.o
build-x86_64/libc_so/syscalls.o: libc/syscalls.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	syscalls.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/syscalls.d -c libc/syscalls.c -o build-x86_64/libc_so/syscalls.o
build-x86_64/libc_so/time.o: libc/time.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	time.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/time.d -c libc/time.c -o build-x86_64/libc_so/time.o
build-x86_64/libc_so/todo.o: libc/todo.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	todo.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/todo.d -c libc/todo.c -o build-x86_64/libc_so/todo.o
build-x86_64/libc_so/unistd.o: libc/unistd.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	unistd.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/unistd.d -c libc/unistd.c -o build-x86_64/libc_so/unistd.o
build-x86_64/libc_so/vector.o: libc/vector.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	vector.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/vector.d -c libc/vector.c -o build-x86_64/libc_so/vector.o
build-x86_64/libc_so/x86_64/nightingale.o: libc/x86_64/nightingale.c
	...
	$(call MP_INFO,CC	nightingale.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/x86_64/nightingale.d -c libc/x86_64/nightingale.c -o build-x86_64/libc_so/x86_64/nightingale.o
build-x86_64/libk.a: build-x86_64/libk/ctype.o build-x86_64/libk/errno.o build-x86_64/libk/malloc.o build-x86_64/libk/setjmp.o build-x86_64/libk/signal.o build-x86_64/libk/stdio.o build-x86_64/libk/stdlib.o build-x86_64/libk/string.o build-x86_64/libk/x86_64/nightingale.o 
	...
	@x86_64-nightingale-ar rcs -o build-x86_64/libk.a build-x86_64/libk/ctype.o build-x86_64/libk/errno.o build-x86_64/libk/malloc.o build-x86_64/libk/setjmp.o build-x86_64/libk/signal.o build-x86_64/libk/stdio.o build-x86_64/libk/stdlib.o build-x86_64/libk/string.o build-x86_64/libk/x86_64/nightingale.o
build-x86_64/libk/ctype.o: libc/ctype.c
	@mkdir -p build-x86_64/libk
	@mkdir -p dep/libk
	$(call MP_INFO,CC	ctype.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -pedantic -ffreestanding -mno-red-zone -mno-80387 -mno-mmx -mno-sse -mno-sse2 -nostdlib -fno-asynchronous-unwind-tables -fno-omit-frame-pointer -DNIGHTINGALE_VERSION=\"$(NIGHTINGALE_VERSION)\" -D__kernel__=1 -D_NG=1 -mcmodel=kernel -fsanitize=undefined $(KERNEL_CFLAGS) -MD -MF dep/libk/ctype.d -c libc/ctype.c -o build-x86_64/libk/ctype.o
...
build-x86_64/sh-/eval.o: sh/eval.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/sh-/eval.d -c sh/eval.c -o build-x86_64/sh-/eval.o
build-x86_64/sh-/parse.o: sh/parse.c
	@mkdir -p build-x86_64/sh-
	@mkdir -p dep/sh-
	$(call MP_INFO,CC	parse.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/sh-/parse.d -c sh/parse.c -o build-x86_64/sh-/parse.o
build-x86_64/sh-/readline.o: sh/readline.c
	@mkdir -p build-x86_64/sh-
	@mkdir -p dep/sh-
	$(call MP_INFO,CC	readline.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/sh-/readline.d -c sh/readline.c -o build-x86_64/sh-/readline.o
build-x86_64/sh-/sh.o: sh/sh.c
	@mkdir -p build-x86_64/sh-
	@mkdir -p dep/sh-
	$(call MP_INFO,CC	sh.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/sh-/sh.d -c sh/sh.c -o build-x86_64/sh-/sh.o
build-x86_64/sh-/token.o: sh/token.c
	@mkdir -p build-x86_64/sh-
	@mkdir -p dep/sh-
	$(call MP_INFO,CC	token.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/sh-/token.d -c sh/token.c -o build-x86_64/sh-/token.o
...
build-x86_64/ld-ng/syscall.o: libc/syscall.c
	...
	@mkdir -p dep/ld-ng
	$(call MP_INFO,CC	syscall.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/ld-ng/syscall.d -c libc/syscall.c -o build-x86_64/ld-ng/syscall.o
build-x86_64/ld-ng/syscalls.o: libc/syscalls.c
	@mkdir -p build-x86_64/ld-ng
	@mkdir -p dep/ld-ng
	$(call MP_INFO,CC	syscalls.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/ld-ng/syscalls.d -c libc/syscalls.c -o build-x86_64/ld-ng/syscalls.o
build-x86_64/ld-ng/elf-ng.o: linker/elf-ng.c
	@mkdir -p build-x86_64/ld-ng
	@mkdir -p dep/ld-ng
	$(call MP_INFO,CC	elf-ng.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/ld-ng/elf-ng.d -c linker/elf-ng.c -o build-x86_64/ld-ng/elf-ng.o
build-x86_64/ld-ng/ldso.o: linker/ldso.c
	@mkdir -p build-x86_64/ld-ng
	@mkdir -p dep/ld-ng
	$(call MP_INFO,CC	ldso.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/ld-ng/ldso.d -c linker/ldso.c -o build-x86_64/ld-ng/ldso.o
build-x86_64/ld-ng/pltstub.o: linker/pltstub.S
	@mkdir -p build-x86_64/ld-ng
	@mkdir -p dep/ld-ng
	$(call MP_INFO,AS	pltstub.o)
	@x86_64-nightingale-gcc  -MD -MF dep/ld-ng/pltstub.d -c linker/pltstub.S -o build-x86_64/ld-ng/pltstub.o
...
build-x86_64/user/ab.o: user/ab.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/ab.d -c user/ab.c -o build-x86_64/user/ab.o
...
build-x86_64/user/args.o: user/args.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/args.d -c user/args.c -o build-x86_64/user/args.o
...
build-x86_64/user/bf.o: user/bf.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/bf.d -c user/bf.c -o build-x86_64/user/bf.o
...
build-x86_64/user/bf2.o: user/bf2.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/bf2.d -c user/bf2.c -o build-x86_64/user/bf2.o
...
build-x86_64/user/bg.o: user/bg.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/bg.d -c user/bg.c -o build-x86_64/user/bg.o
...
build-x86_64/user/bomb.o: user/bomb.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/bomb.d -c user/bomb.c -o build-x86_64/user/bomb.o
...
build-x86_64/user/busy.o: user/busy.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/busy.d -c user/busy.c -o build-x86_64/user/busy.o
...
build-x86_64/user/cat.o: user/cat.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/cat.d -c user/cat.c -o build-x86_64/user/cat.o
...
build-x86_64/user/cforks.o: user/cforks.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/cforks.d -c user/cforks.c -o build-x86_64/user/cforks.o
...
build-x86_64/user/chmod.o: user/chmod.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/chmod.d -c user/chmod.c -o build-x86_64/user/chmod.o
...
build-x86_64/user/clone.o: user/clone.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/clone.d -c user/clone.c -o build-x86_64/user/clone.o
...
build-x86_64/user/column.o: user/column.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/column.d -c user/column.c -o build-x86_64/user/column.o
...
build-x86_64/user/crash.o: user/crash.c
	...
	@mkdir -p dep/user
	$(call MP_INFO,CC	crash.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/crash.d -c user/crash.c -o build-x86_64/user/crash.o
...
build-x86_64/user/create.o: user/create.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/create.d -c user/create.c -o build-x86_64/user/create.o
...
build-x86_64/user/dg.o: user/dg.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/dg.d -c user/dg.c -o build-x86_64/user/dg.o
...
build-x86_64/user/echo.o: user/echo.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/echo.d -c user/echo.c -o build-x86_64/user/echo.o
...
build-x86_64/user/false.o: user/false.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/false.d -c user/false.c -o build-x86_64/user/false.o
...
build-x86_64/user/float.o: user/float.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/float.d -c user/float.c -o build-x86_64/user/float.o
...
build-x86_64/user/forks.o: user/forks.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/forks.d -c user/forks.c -o build-x86_64/user/forks.o
...
build-x86_64/user/head.o: user/head.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/head.d -c user/head.c -o build-x86_64/user/head.o
...
build-x86_64/user/hog.o: user/hog.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/hog.d -c user/hog.c -o build-x86_64/user/hog.o
...
build-x86_64/user/init.o: user/init.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/init.d -c user/init.c -o build-x86_64/user/init.o
...
build-x86_64/user/insmod.o: user/insmod.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/insmod.d -c user/insmod.c -o build-x86_64/user/insmod.o
...
build-x86_64/user/kill.o: user/kill.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/kill.d -c user/kill.c -o build-x86_64/user/kill.o
...
build-x86_64/user/ls.o: user/ls.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/ls.d -c user/ls.c -o build-x86_64/user/ls.o
...
build-x86_64/user/mb.o: user/mb.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/mb.d -c user/mb.c -o build-x86_64/user/mb.o
...
build-x86_64/user/mmap.o: user/mmap.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/mmap.d -c user/mmap.c -o build-x86_64/user/mmap.o
...
build-x86_64/user/modsys.o: user/modsys.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/modsys.d -c user/modsys.c -o build-x86_64/user/modsys.o
...
build-x86_64/user/oom.o: user/oom.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/oom.d -c user/oom.c -o build-x86_64/user/oom.o
...
build-x86_64/user/rm.o: user/rm.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/rm.d -c user/rm.c -o build-x86_64/user/rm.o
...
build-x86_64/user/rot13.o: user/rot13.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/rot13.d -c user/rot13.c -o build-x86_64/user/rot13.o
...
build-x86_64/user/sc.o: user/sc.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/sc.d -c user/sc.c -o build-x86_64/user/sc.o
...
build-x86_64/user/sleep.o: user/sleep.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/sleep.d -c user/sleep.c -o build-x86_64/user/sleep.o
...
build-x86_64/user/st.o: user/st.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/st.d -c user/st.c -o build-x86_64/user/st.o
...
build-x86_64/user/step.o: user/step.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/step.d -c user/step.c -o build-x86_64/user/step.o
...
build-x86_64/user/strace.o: user/strace.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/strace.d -c user/strace.c -o build-x86_64/user/strace.o
...
build-x86_64/user/test.o: user/test.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/test.d -c user/test.c -o build-x86_64/user/test.o
...
build-x86_64/user/threads.o: user/threads.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/threads.d -c user/threads.c -o build-x86_64/user/threads.o
...
build-x86_64/user/time.o: user/time.c
	...
	@mkdir -p dep/user
	$(call MP_INFO,CC	time.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/time.d -c user/time.c -o build-x86_64/user/time.o
...
build-x86_64/user/top.o: user/top.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/top.d -c user/top.c -o build-x86_64/user/top.o
...
build-x86_64/user/trace.o: user/trace.c
	...
	@mkdir -p dep/user
	$(call MP_INFO,CC	trace.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/trace.d -c user/trace.c -o build-x86_64/user/trace.o
...
build-x86_64/user/traceback.o: user/traceback.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/traceback.d -c user/traceback.c -o build-x86_64/user/traceback.o
...
build-x86_64/user/uname.o: user/uname.c
	...
	@mkdir -p dep/user
	$(call MP_INFO,CC	uname.o)
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/uname.d -c user/uname.c -o build-x86_64/user/uname.o
...
build-x86_64/user/uthread.o: user/uthread.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/uthread.d -c user/uthread.c -o build-x86_64/user/uthread.o
...
build-x86_64/user/xd.o: user/xd.c
	...
	@x86_64-nightingale-gcc -std=c11 --sysroot=./sysroot -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch $(USER_CFLAGS) -static -MD -MF dep/user/xd.d -c user/xd.c -o build-x86_64/user/xd.o
...
MP_ALL_INSTALL_TARGETS := sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a sysroot/usr/lib/libc.so ngk.elf sysroot/usr/lib/crt0.o sysroot/bin/sh sysroot/bin/ld-ng.so sysroot/bin/bss.ko sysroot/bin/crash.ko sysroot/bin/file.ko sysroot/bin/procmod.ko sysroot/bin/syscall.ko sysroot/bin/testmod.ko sysroot/bin/thread.ko sysroot/bin/ab sysroot/bin/args sysroot/bin/bf sysroot/bin/bf2 sysroot/bin/bg sysroot/bin/bomb sysroot/bin/busy sysroot/bin/cat sysroot/bin/cforks sysroot/bin/chmod sysroot/bin/clone sysroot/bin/column sysroot/bin/crash sysroot/bin/create sysroot/bin/dg sysroot/bin/echo sysroot/bin/false sysroot/bin/float sysroot/bin/forks sysroot/bin/head sysroot/bin/hog sysroot/bin/init sysroot/bin/insmod sysroot/bin/kill sysroot/bin/ls sysroot/bin/mb sysroot/bin/mmap sysroot/bin/modsys sysroot/bin/oom sysroot/bin/rm sysroot/bin/rot13 sysroot/bin/sc sysroot/bin/sleep sysroot/bin/st sysroot/bin/step sysroot/bin/strace sysroot/bin/test sysroot/bin/threads sysroot/bin/time sysroot/bin/top sysroot/bin/trace sysroot/bin/traceback sysroot/bin/uname sysroot/bin/uthread sysroot/bin/xd
...
MP_ALL_TARGETS := build-x86_64/libc.a build-x86_64/libm.a build-x86_64/libelf.a build-x86_64/libc.so build-x86_64/libk.a build-x86_64/ngk.elf build-x86_64/crt0.o build-x86_64/sh build-x86_64/ld-ng.so build-x86_64/bss.ko build-x86_64/crash.ko build-x86_64/file.ko build-x86_64/procmod.ko build-x86_64/syscall.ko build-x86_64/testmod.ko build-x86_64/thread.ko build-x86_64/ab build-x86_64/args build-x86_64/bf build-x86_64/bf2 build-x86_64/bg build-x86_64/bomb build-x86_64/busy build-x86_64/cat build-x86_64/cforks build-x86_64/chmod build-x86_64/clone build-x86_64/column build-x86_64/crash build-x86_64/create build-x86_64/dg build-x86_64/echo build-x86_64/false build-x86_64/float build-x86_64/forks build-x86_64/head build-x86_64/hog build-x86_64/init build-x86_64/insmod build-x86_64/kill build-x86_64/ls build-x86_64/mb build-x86_64/mmap build-x86_64/modsys build-x86_64/oom build-x86_64/rm build-x86_64/rot13 build-x86_64/sc build-x86_64/sleep build-x86_64/st build-x86_64/step build-x86_64/strace build-x86_64/test build-x86_64/threads build-x86_64/time build-x86_64/top build-x86_64/trace build-x86_64/traceback build-x86_64/uname build-x86_64/uthread build-x86_64/xd
MP_ALL_OBJECTS := build-x86_64/libc.a build-x86_64/libc/crt0.o build-x86_64/libc/crti.o build-x86_64/libc/crtn.o build-x86_64/libc/ctype.o build-x86_64/libc/entry.o build-x86_64/libc/errno.o build-x86_64/libc/fstdio.o build-x86_64/libc/fstdio_unlocked.o build-x86_64/libc/getopt.o build-x86_64/libc/locale.o build-x86_64/libc/malloc.o build-x86_64/libc/nightingale.o build-x86_64/libc/setjmp.o build-x86_64/libc/signal.o build-x86_64/libc/stdio.o build-x86_64/libc/stdlib.o build-x86_64/libc/string.o build-x86_64/libc/strtod.o build-x86_64/libc/syscall.o build-x86_64/libc/syscalls.o build-x86_64/libc/time.o build-x86_64/libc/todo.o build-x86_64/libc/unistd.o build-x86_64/libc/vector.o build-x86_64/libc/x86_64/nightingale.o build-x86_64/libm.a build-x86_64/libm/complex.o build-x86_64/libm/double.o build-x86_64/libelf.a build-x86_64/libelf/elf-ng.o build-x86_64/libc.so build-x86_64/libc_so/crt0.o build-x86_64/libc_so/crti.o build-x86_64/libc_so/crtn.o build-x86_64/libc_so/ctype.o build-x86_64/libc_so/entry.o build-x86_64/libc_so/errno.o build-x86_64/libc_so/fstdio.o build-x86_64/libc_so/fstdio_unlocked.o build-x86_64/libc_so/getopt.o build-x86_64/libc_so/locale.o build-x86_64/libc_so/malloc.o build-x86_64/libc_so/nightingale.o build-x86_64/libc_so/setjmp.o build-x86_64/libc_so/signal.o build-x86_64/libc_so/stdio.o build-x86_64/libc_so/stdlib.o build-x86_64/libc_so/string.o build-x86_64/libc_so/strtod.o build-x86_64/libc_so/syscall.o build-x86_64/libc_so/syscalls.o build-x86_64/libc_so/time.o build-x86_64/libc_so/todo.o build-x86_64/libc_so/unistd.o build-x86_64/libc_so/vector.o build-x86_64/libc_so/x86_64/nightingale.o build-x86_64/libk.a build-x86_64/libk/ctype.o build-x86_64/libk/errno.o build-x86_64/libk/malloc.o build-x86_64/libk/setjmp.o build-x86_64/libk/signal.o build-x86_64/libk/stdio.o build-x86_64/libk/stdlib.o build-x86_64/libk/string.o build-x86_64/libk/x86_64/nightingale.o build-x86_64/ngk.elf build-x86_64/fs/char_devices.o build-x86_64/fs/directory.o build-x86_64/fs/fs.o build-x86_64/fs/membuf.o build-x86_64/fs/pipe.o build-x86_64/fs/procfs.o build-x86_64/fs/socket.o build-x86_64/kernel/debug.o build-x86_64/kernel/dmgr.o build-x86_64/kernel/elf.o build-x86_64/kernel/exec.o build-x86_64/kernel/irq.o build-x86_64/kernel/main.o build-x86_64/kernel/mman.o build-x86_64/kernel/mod.o build-x86_64/kernel/multiboot.o build-x86_64/kernel/pci.o build-x86_64/kernel/pmm.o build-x86_64/kernel/rand.o build-x86_64/kernel/ringbuf.o build-x86_64/kernel/serial.o build-x86_64/kernel/signal.o build-x86_64/kernel/spalloc.o build-x86_64/kernel/string.o build-x86_64/kernel/sync.o build-x86_64/kernel/sync_testbed.o build-x86_64/kernel/syscall.o build-x86_64/kernel/tarfs.o build-x86_64/kernel/tests.o build-x86_64/kernel/thread.o build-x86_64/kernel/timer.o build-x86_64/kernel/trace.o build-x86_64/kernel/tty.o build-x86_64/kernel/ubsan.o build-x86_64/kernel/uname.o build-x86_64/linker/elf-ng.o build-x86_64/linker/modld.o build-x86_64/x86/acpi.o build-x86_64/x86/apic.o build-x86_64/x86/boot.o build-x86_64/x86/cpu.o build-x86_64/x86/halt.o build-x86_64/x86/interrupt.o build-x86_64/x86/isrs.o build-x86_64/x86/pic.o build-x86_64/x86/pit.o build-x86_64/x86/uart.o build-x86_64/x86/vmm.o build-x86_64/crt0.o build-x86_64/crt/crt0.o build-x86_64/sh build-x86_64/sh-/eval.o build-x86_64/sh-/parse.o build-x86_64/sh-/readline.o build-x86_64/sh-/sh.o build-x86_64/sh-/token.o build-x86_64/ld-ng.so build-x86_64/ld-ng/syscall.o build-x86_64/ld-ng/syscalls.o build-x86_64/ld-ng/elf-ng.o build-x86_64/ld-ng/ldso.o build-x86_64/ld-ng/pltstub.o build-x86_64/bss.ko build-x86_64/modules/bss.o build-x86_64/crash.ko build-x86_64/modules/crash.o build-x86_64/file.ko build-x86_64/modules/file.o build-x86_64/procmod.ko build-x86_64/modules/procmod.o build-x86_64/syscall.ko build-x86_64/modules/syscall.o build-x86_64/testmod.ko build-x86_64/modules/testmod.o build-x86_64/thread.ko build-x86_64/modules/thread.o build-x86_64/ab build-x86_64/user/ab.o build-x86_64/args build-x86_64/user/args.o build-x86_64/bf build-x86_64/user/bf.o build-x86_64/bf2 build-x86_64/user/bf2.o build-x86_64/bg build-x86_64/user/bg.o build-x86_64/bomb build-x86_64/user/bomb.o build-x86_64/busy build-x86_64/user/busy.o build-x86_64/cat build-x86_64/user/cat.o build-x86_64/cforks build-x86_64/user/cforks.o build-x86_64/chmod build-x86_64/user/chmod.o build-x86_64/clone build-x86_64/user/clone.o build-x86_64/column build-x86_64/user/column.o build-x86_64/crash build-x86_64/user/crash.o build-x86_64/create build-x86_64/user/create.o build-x86_64/dg build-x86_64/user/dg.o build-x86_64/echo build-x86_64/user/echo.o build-x86_64/false build-x86_64/user/false.o build-x86_64/float build-x86_64/user/float.o build-x86_64/forks build-x86_64/user/forks.o build-x86_64/head build-x86_64/user/head.o build-x86_64/hog build-x86_64/user/hog.o build-x86_64/init build-x86_64/user/init.o build-x86_64/insmod build-x86_64/user/insmod.o build-x86_64/kill build-x86_64/user/kill.o build-x86_64/ls build-x86_64/user/ls.o build-x86_64/mb build-x86_64/user/mb.o build-x86_64/mmap build-x86_64/user/mmap.o build-x86_64/modsys build-x86_64/user/modsys.o build-x86_64/oom build-x86_64/user/oom.o build-x86_64/rm build-x86_64/user/rm.o build-x86_64/rot13 build-x86_64/user/rot13.o build-x86_64/sc build-x86_64/user/sc.o build-x86_64/sleep build-x86_64/user/sleep.o build-x86_64/st build-x86_64/user/st.o build-x86_64/step build-x86_64/user/step.o build-x86_64/strace build-x86_64/user/strace.o build-x86_64/test build-x86_64/user/test.o build-x86_64/threads build-x86_64/user/threads.o build-x86_64/time build-x86_64/user/time.o build-x86_64/top build-x86_64/user/top.o build-x86_64/trace build-x86_64/user/trace.o build-x86_64/traceback build-x86_64/user/traceback.o build-x86_64/uname build-x86_64/user/uname.o build-x86_64/uthread build-x86_64/user/uthread.o build-x86_64/xd build-x86_64/user/xd.o
