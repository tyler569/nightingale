...
File.open("kernel/include/ng/autogenerated_syscall_consts.h", "w") do |f|
...
File.open("kernel/include/ng/autogenerated_syscalls.h", "w") do |f|
  syscalls.map(&:kernel_header).each { |s| f.puts s }
end

File.open("kernel/autogenerated_syscalls.inc", "w") do |f|
...
File.open("libc/include/autogenerated_syscall_names.h", "w") do |f|
  f.puts "const char *syscall_names[] = {"
  syscalls.map(&:user_map).each { |s| f.puts s }
  f.puts "};"
end

File.open("libc/include/autogenerated_syscalls.h", "w") do |f|
  syscalls.map(&:user_header).each { |s| f.puts s }
end

File.open("libc/autogenerated_syscalls.inc", "w") do |f|
