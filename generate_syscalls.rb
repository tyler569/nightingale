...
header_guard("libc/include/autogenerated_errnos.h") do |f|
...
write("libc/autogenerated_errnos.inc") do |f| 
  f.puts "const char *errno_names[] = {"
  errnos.map(&:name_map).each { |s| f.puts s }
  f.puts "};"
  f.puts "const char *perror_strings[] = {"
