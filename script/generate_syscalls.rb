...
write("kernel/autogenerated_syscalls.c") do |f|
...
write("libc/autogenerated_syscall_names.c") do |f|
  f.puts "const char *syscall_names[] = {"
  syscalls.map(&:user_map).each { |s| f.puts s }
  f.puts "};"
end

write("libc/autogenerated_syscalls.c") do |f|
...
write("libc/autogenerated_errnos.c") do |f|
