...
private:
    ...
    static constexpr size_t rx_buffer_pages = 16;
    ...
    static constexpr uint8_t cmd_rx_enable = 0x04;
    static constexpr uint8_t cmd_tx_enable = 0x08;
    ...
    static constexpr uint16_t intr_link_change = 0x2000;
    static constexpr uint16_t intr_rx_fifo_overflow = 0x4000;
    static constexpr uint16_t intr_tx_fifo_underrun = 0x8000;
