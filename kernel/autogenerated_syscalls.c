...
sysret (*syscall_table[SYSCALL_TABLE_SIZE])() = {
    ...
    [NG_SYSCALL_TRACE] = sys_syscall_trace,
    [NG_BIND] = sys_bind,
    ...
    [NG_UNLINK] = sys_unlink,
    [NG_CHMOD] = sys_chmod,
    [NG_FCHMOD] = sys_fchmod,
...
const char *syscall_debuginfos[SYSCALL_TABLE_SIZE] = {
    ...
    [NG_SYSCALL_TRACE] = "syscall_trace(%zi, %zi)",
...
const char *syscall_names[SYSCALL_TABLE_SIZE] = {
    ...
    [NG_EXECVE] = "execve",
    [NG_SOCKET] = "socket",
    [NG_SYSCALL_TRACE] = "syscall_trace",
    [NG_BIND] = "bind",
    [NG_CONNECT] = "connect",
    [NG_SEND] = "send",
    [NG_SENDTO] = "sendto",
