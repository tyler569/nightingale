...
USED void __ubsan_handle_negate_overflow(
        struct ubsan_overflow_info* info,
        unsigned long value
    ) {
...
USED void __ubsan_handle_add_overflow(
        struct ubsan_overflow_info* info,
    ...
    printf("  lhs: %lu, rhs: %lu, type: %s\n",
        value_lhs, value_rhs, &(info->type->type_name)
    );
    print_sloc(&(info->loc));
    backtrace_from_here(20);
    panic("");
...
USED void __ubsan_handle_sub_overflow(
        struct ubsan_overflow_info* info,
        unsigned long value_lhs,
        unsigned long value_rhs
    ) {
...
USED void __ubsan_handle_mul_overflow(
        struct ubsan_overflow_info* info,
        unsigned long value_lhs,
        unsigned long value_rhs
    ) {
...
USED void __ubsan_handle_divrem_overflow(
        struct ubsan_overflow_info* info,
        unsigned long value_lhs,
        unsigned long value_rhs
    ) {
...
USED void __ubsan_handle_load_invalid_value(
        struct ubsan_invalid_value_info* info,
        unsigned long value
    ) {
...
USED void __ubsan_handle_shift_out_of_bounds(
        struct ubsan_shift_oob_info* info,
        unsigned long value_lhs,
        unsigned long value_rhs
    ) {
