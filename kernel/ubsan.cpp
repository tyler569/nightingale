...
[[maybe_unused]] void __ubsan_handle_negate_overflow(
...
[[maybe_unused]] void __ubsan_handle_add_overflow(struct overflow_info *info,
...
[[maybe_unused]] void __ubsan_handle_sub_overflow(struct overflow_info *info,
    unsigned long value_lhs, unsigned long value_rhs)
{
...
[[maybe_unused]] void __ubsan_handle_mul_overflow(struct overflow_info *info,
    unsigned long value_lhs, unsigned long value_rhs)
{
...
[[maybe_unused]] void __ubsan_handle_divrem_overflow(struct overflow_info *info,
    unsigned long value_lhs, unsigned long value_rhs)
{
...
[[maybe_unused]] void __ubsan_handle_shift_out_of_bounds(
    struct shift_oob_info *info, unsigned long value_lhs,
...
[[maybe_unused]] void __ubsan_handle_type_mismatch_v1(
...
[[maybe_unused]] void __ubsan_handle_nonnull_arg(struct nonnull_arg_info *info)
{
...
[[maybe_unused]] void __ubsan_handle_function_type_mismatch()
{
...
[[maybe_unused]] void __ubsan_handle_vla_bound_not_positive()
{
    printf("ubsan: vla bound not positive detected\n");
    printf("INFO TODO\n");
    panic_bt("ubsan");
}

[[maybe_unused]] void __ubsan_handle_nonnull_return_v1()
{
    printf("ubsan: nonnull return detected\n");
    printf("INFO TODO\n");
    panic_bt("ubsan");
}
}