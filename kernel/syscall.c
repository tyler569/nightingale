...
const uintptr_t syscall_table[] = {
        ...
        [NG_WAIT4]      = 0, // removed
        [NG_SOCKET]     = 0, // (uintptr_t) sys_socket,
        [NG_BIND0]      = 0, // removed
        [NG_CONNECT0]   = 0, // removed
        [NG_STRACE]     = (uintptr_t) sys_strace,
        [NG_BIND]       = 0, // (uintptr_t) sys_bind,
        [NG_CONNECT]    = 0, // (uintptr_t) sys_connect,
        [NG_SEND]       = 0, // (uintptr_t) sys_send,
        [NG_SENDTO]     = 0, // (uintptr_t) sys_sendto,
        [NG_RECV]       = 0, // (uintptr_t) sys_recv,
        [NG_RECVFROM]   = 0, // (uintptr_t) sys_recvfrom,
